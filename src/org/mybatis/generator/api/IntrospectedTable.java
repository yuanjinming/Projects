...
public abstract class IntrospectedTable {
    ...
    public IntrospectedColumn getColumn(String columnName) {
        if (columnName == null) {
        	...
        	if (primaryKeyColumn.isColumnNameDelimited()) {
                if (primaryKeyColumn.getActualColumnName().equals(
                        columnName)) {
                    return primaryKeyColumn;
                }
            } else {
                if (primaryKeyColumn.getActualColumnName()
    ...
    public boolean hasJDBCTimeColumns() {
        ...
        if (primaryKeyColumn.isJDBCTimeColumn()) {
            rc = true;
        }
    ...
    public int getColumnCount() {
        return (primaryKeyColumn != null ? 1 : 0) + baseColumns.size();
    }
