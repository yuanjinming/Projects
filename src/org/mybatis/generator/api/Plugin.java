...
public interface Plugin {
 ...
 RECORD_WITH_BLOBS
    ...
    boolean clientAddMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientDeleteMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientGetMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientDeleteByMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientUpdateMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientUpdateByMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientGetListMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientCountMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
    boolean clientRunSqlMethodGenerated(Method method,
    		TopLevelClass topLevelClass, IntrospectedTable introspectedTable);
	...
	boolean sqlMapGetElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapDeleteElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapDeleteByElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapAddElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapUpdateElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapRunSqlElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapUpdateByElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapGetListElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapCountElementGenerated(XmlElement element, IntrospectedTable introspectedTable);

	boolean sqlMapBaseColumnListElementGenerated(XmlElement element, IntrospectedTable introspectedTable);
	
	boolean sqlMapResultMapElementGenerated(XmlElement element, IntrospectedTable introspectedTable);
}
