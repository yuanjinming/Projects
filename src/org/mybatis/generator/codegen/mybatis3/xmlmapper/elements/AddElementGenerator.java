...
public class AddElementGenerator extends AbstractXmlElementGenerator {
    ...
    public void addElements(XmlElement parentElement) {
        ...
        valuesForeachClause.addAttribute(new Attribute("item", "item"));
        ...
        for (String clause : valuesClauses) {
        	valuesForeachClause.addElement(new TextElement(clause));
        }

        if (context.getPlugins().sqlMapAddElementGenerated(answer,
                introspectedTable)) {
